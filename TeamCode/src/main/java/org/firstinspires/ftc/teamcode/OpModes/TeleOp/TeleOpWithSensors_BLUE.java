        ...
        while(opModeIsActive()){
            ...
            if(state==State.CONTROLLING)
            {
                ...
                if(inTeleop){
                    ...
                    if((gamepad1.circle) && (outtake.state==Outtake.State.DeafultWithElement || outtake.state== Outtake.State.ReleaseSample) && outtake.haveSample==true && outtake.inPosition())
                    {
